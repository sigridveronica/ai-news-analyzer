...
from fin_interpreter import analyze_article  # Your AI4Finance interpreter module
...
llm = ChatOpenAI(model_name="gpt-4.1", openai_api_key=OPENAI_KEY)
...
# === Related Terms with GPT ===
def get_related_terms(topic):
    prompt = f"List synonyms and related terms for '{topic}' in the context of news and finance. Provide a comma-separated list."
...
def generate_value_investor_report(topic, news_results, max_articles=20, max_chars_per_article=400):
    ...
    # Run sentiment + investment analysis
    ...
    # === Prompt for GPT Markdown generation ===
